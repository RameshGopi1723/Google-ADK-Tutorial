...
async def get_agent():
    # Wrap StdioServerParameters inside StdioConnectionParams
...
async def main(query):
    ...
    await session_serivce.create_session(
    ...
    runner = Runner(
        app_name=APP_NAME, agent=root_agent, session_service=session_serivce
    )
